...
export default class ClientsPage implements OnInit {
  ...
  readonly physForm = this.fb.nonNullable.group({
    ...
    passportSeries: ['', [Validators.required, Validators.minLength(2), Validators.maxLength(2)]],
    passportNumber: ['', [Validators.required, Validators.minLength(7), Validators.maxLength(7)]],
    actualAddress: [''],
    phone: [''],
  });
